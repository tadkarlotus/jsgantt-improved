...
export const getXMLTask = function (pID, pIdx) {
  ...
  if (vIdx >= 0 && vIdx < this.vTaskList.length) {
    ...
    vTask += '<pStart>' + formatDateStr(this.vTaskList[vIdx].getStart(), vOutFrmt, this.vLangs[this.vLang], this.vLang) + '</pStart>';
    vTask += '<pEnd>' + formatDateStr(this.vTaskList[vIdx].getEnd(), vOutFrmt, this.vLangs[this.vLang], this.vLang) + '</pEnd>';
    vTask += '<pPlanStart>' + formatDateStr(this.vTaskList[vIdx].getPlanStart(), vOutFrmt, this.vLangs[this.vLang], this.vLang) + '</pPlanStart>';
    vTask += '<pPlanEnd>' + formatDateStr(this.vTaskList[vIdx].getPlanEnd(), vOutFrmt, this.vLangs[this.vLang], this.vLang) + '</pPlanEnd>';
